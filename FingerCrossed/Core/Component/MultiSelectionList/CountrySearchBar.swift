...
struct CountrySearchBar: View {
    ...
    var body: some View {
        HStack (alignment: .top, spacing: 0){
            if countrySelectionList.countrySlections.count >= 1 {
                VStack (alignment: .leading, spacing: 10.0){
                    ...
                    VStack (alignment: .leading, spacing: 10.0) {
                        countrySelectionList.countrySlections.count >= 3 ? nil : isDisplay ? nil : Divider()
        ...
        .frame(height: flexibleHeight(count: countrySelectionList.countrySlections.count, isDisplay: isDisplay))
...
struct CountrySearchBar_Previews: PreviewProvider {
    static var previews: some View {
        CountrySearchBar(countrySelectionList: CountrySelectionList(countrySlections: [CountryModel]()), countryName: value)
    }
}
