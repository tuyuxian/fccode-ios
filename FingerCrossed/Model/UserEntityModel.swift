...
class UserEntityModel: ObservableObject{
    ...
    init(id: UUID, email: String, password: String, username: String, dateOfBirth: Date, gender: Gender, avatarURL: String, selfIntro: String, longitude: Float, latitude: Float, voiceContentURL: String, matchingDistance: Int, googleConnect: Bool, facebookConnect: Bool, appleConnect: Bool, premium: Bool, goal: [GoalModel], citizen: [CountryModel], lifePhoto: [LifePhoto], socialAccount: [SocialAccount], ethnicity: [Ethnicity]) {
        self.id = id
        self.email = email
