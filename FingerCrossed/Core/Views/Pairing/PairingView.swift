    ...
    @State var candidateList: [CandidateModel] = [
        ...
        CandidateModel(
            lifePhotoList: [
                LifePhoto(
                    // swiftlint: disable line_length
                    contentUrl: "https://img.freepik.com/free-photo/lovely-woman-white-dress_144627-23529.jpg?w=1800&t=st=1681804694~exp=1681805294~hmac=c33ecc06aa1daacd3995cbbadb1ef536b15cb90f1730332fea1f3ab717fbcd0d",
                    // swiftlint: enable line_length
                    caption: "caption1",
                    position: 0,
                    scale: 1,
                ...
                LifePhoto(
                    // swiftlint: disable line_length
                    contentUrl: "https://img.freepik.com/premium-photo/woman-sits-table-with-laptop-front-her-freelance-remote-work_401253-999.jpg?w=740",
                    // swiftlint: enable line_length
                    caption: "caption2",
                    position: 1,
                    scale: 1,
...
struct Instruction: View {
    ...
    var body: some View {
        switch step {
        case 1:
            InstructionSwipLeftRight()
            
        case 2:
            InstructionSwipUp()
            
        case 3:
            InstructionDoubleTap()
            
        default:
            InstructionDefaultItem()
        }
    }
}
