...
extension PrivacySheet {
    
    // swiftlint: disable line_length
    public struct Privacy: View {
        var body: some View {
            Group {
                Group {
                    Text("Introduction")
                ...
                Group {
                    ...
                    PrivacySheet.InformationWeCollect()
                    // Use of Information
                    PrivacySheet.UseOfInformation()
                    // Sharing of Information
                    PrivacySheet.SharingOfInformation()
                    // Data Security
                    PrivacySheet.DataSecurity()
                    // User Control
                    PrivacySheet.UserControl()
                    // Children's Privacy
                    PrivacySheet.ChildrensPrivacy()
                    // Changes to Privacy Policy
                    PrivacySheet.ChangesToPrivacyPolicy()
                }
            }
        }
    }
