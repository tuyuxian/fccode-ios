    ...
    public struct TermsOfService: View {
        var body: some View {
            Group {
                ...
                Group {
                    // Eligibility
                    TermsOfServiceSheet.Eligibility()
                    
                    // User Content and Profiles
                    TermsOfServiceSheet.UserContentAndProfiles()
                    
                    // User Conduct
                    TermsOfServiceSheet.UserConduct()
                    
                    // Safety
                    TermsOfServiceSheet.Safety()
                    
                    // Reporting and Blocking
                    TermsOfServiceSheet.ReportingAndBlocking()
                    
                    // Intellectual Property
                    TermsOfServiceSheet.IntellectualProperty()
                    
                    // Limitation of Liability
                    TermsOfServiceSheet.LimitationOfLiability()
                    
                    // Termination
                    TermsOfServiceSheet.Termination()
                    
                    // Chandes to Terms and Conditions
                    TermsOfServiceSheet.ChandesToTermsAndConditions()
                }
            }
        }
    }
